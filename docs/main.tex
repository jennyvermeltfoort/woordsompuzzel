...
\begin{table}[h]
    ...
    \resizebox{\columnwidth}{!}{ % Verklein de tabel naar de kolombreedte
        \begin{tabular}{|p{0.2\textwidth}|p{0.05\textwidth}|p{0.07\textwidth}|p{0.08\textwidth}|}
            ...
            \hline
            KLAAS + PAARD = ... & 10 & 20224 & \SI{1.78155}{\second} \\
            \hline
            MIJTER + MANTEL = ... & 10 & 550024 & \SI{23.3912}{\second} \\
            \hline
        \end{tabular}
    }
\end{table}
...
\begin{appendices}
    ...
    \begin{lstlisting}
        ...
        We vonden 20224 puzzels met een unieke oplossing.
        Het construeren van de puzzels kostte 1781549 clock ticks, ofwel 1.78155 seconden.
