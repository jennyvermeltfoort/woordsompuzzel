// Hoofdprogramma voor oplossing voor tweede programmeeropdracht
// Algoritmiek, voorjaar 2025: Woordsompuzzel
//
// Biedt de gebruiker een menustructuur om
// * een grondtal en een drietal woorden op te geven waarbij waardes
// aan
//   letters kunnen worden toegekend, letters weer kunnen worden
//   vrijgemaakt, en het aantal oplossingen kan worden bepaald
// * een grondtal en twee woorden op te geven, waarbij complete
// puzzels
...
// Vraag de gebruiker om de drie woorden van een woordsompuzzel, en
// bied een menu om met deze puzzel te werken.
void doePuzzel() {
    WoordSomPuzzel *wsp1;  // pointer, om makkeijk nieuwe objecten te
    ...
    do {
        ...
        switch (keuze) {
            case 1:
                cout << endl;
                cout << "Geef de letter waaraan je een waarde wil "
                        "toekennen: ";
            ...
            case 3:
                t1 = clock();
                nrOplossingen =
                    wsp1->zoekOplossingen(deelOplossingen, oplossing);
                t2 = clock();

                cout << endl;
                cout << "De puzzel kent " << nrOplossingen
                     << " verschillende oplossing(en)." << endl;
                cout << "Het zoeken van de oplossingen kostte "
                     << (t2 - t1) << " clock ticks, ofwel "
...
// Vraag de gebruiker om de eerste twee woorden van een
// woordsompuzzel, en bepaal daarbij het aantal complete puzzels met
...
void construeerPuzzels() {
    ...
    if (nwWoord[0].length() >
        ...
        wsp1 = new WoordSomPuzzel(grondtal, nwWoord[0], nwWoord[1],
                                  nwWoord[1]);
    // We geven nwWoord[0] of nwWoord[1] twee keer mee, ook als woord
    // dat de som moet voorstellen. Uiteindelijk gaan we die som niet
    // gebruiken.
    ...
    cout << endl;
    cout << "We vonden " << nrPuzzels
         << " puzzels met een unieke oplossing." << endl;
...
void hoofdmenu() {
    ...
    do {
        ...
        cout << "2. Woordsom-puzzels construeren bij twee gegeven "
                "woorden"
             << endl;
        cout << "3. Stoppen" << endl;
        cout << endl;
